/*Write a C program to implement folding, division and mid-square
 techniques tosearch an item using a Hash Table of size 11.
 Where the given array elements are:
